        ...
        <div class="panel panel-default">
          ...
          <div class="panel-body">
            <?php if (($transaksi) != null) : ?>
              Anda memiliki <?php ($transaksi) ?> pemesanan : <br>
              <ul class="list-unstyled">
                      ...
                      <div class="tab-content">
                        ...
                        <div role="tabpanel" class="tab-pane active" id="gedung">
                          <div class="row">
                            ...
                            <?php else : ?>
                              <h4>
                                <center>Maaf tidak ada gedung yang tersedia pada tanggal ini</center>
                              </h4>
                            <?php endif; ?>
                          </div>
                        </div>
                        ...
                        <div role="tabpanel" class="tab-pane" id="dekorasi">
                          <div class="row">
                            ...
                            <?php else : ?>
                              <h4>
                                <center>Maaf tidak ada dekorasi yang tersedia pada tanggal ini</center>
                              </h4>
                            <?php endif; ?>
                          </div>
                        </div>
